...
describe("Steps components", () => {
  it("renders all step components", () => {
    ...
    cy.mount(
      <Step1Tech formData={mockFormData} setFormData={setMockFormData} />,
    );
    cy.mount(
      <Step2Interests formData={mockFormData} setFormData={setMockFormData} />,
    );
    cy.mount(
      <Step0AboutYou formData={mockFormData} setFormData={setMockFormData} />,
    );
  });
});
