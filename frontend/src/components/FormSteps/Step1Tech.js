...
function Step1Tech({formData, setFormData}) {
  ...
  return (
    <div className='tech-container form-step-container'>
      ...
      <label className="font-bold" for="skills">Your existing skills</label>
      <input
      ...
      <label className="font-bold" for="skills_to_learn">Skills you want to learn</label>
      <input
        className='input-field'
        type='text' 
        id="skills_to_learn" 
      ...
      <label className="font-bold" for="area_of_programming" >Area of programming</label>
      <select 
        className='input-field'
